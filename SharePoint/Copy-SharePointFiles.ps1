<#	
	...
	===========================================================================
	 ...
	 Created on:   	4/11/2023 8:37 AM
	 Created by:   	Gary Cook
	 Organization: 	Quest
	 Filename:     	Copy-SharePointFiles.ps1
	===========================================================================
	.DESCRIPTION
		Copy Sharepoint online files from one library to another.
#>
...
Function Copy-PnPLibrary
{
	...
	Try
	{
		...
		If ($SourceLibrary.ItemCount -gt 0)
		{
			...
			$global:counter = 0
			$ListItems = Get-PnPListItem -List $SourceLibraryName -Connection $SourceConn -PageSize 500 -Fields ID -ScriptBlock {
