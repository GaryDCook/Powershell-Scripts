...
$priority = "Normal" 
$smtpServer = "10.1.4.136" 
$emailFrom = "rdplist@mcclabel.com" 
$emailTo = "John.Halbert@mcclabel.com" 
...
ForEach ($Server in $Servers) { 
    ...
    ForEach ($queryResult in $queryResults) { 
        ...
        If (($RDPUser -match "[a-z]") -and ($RDPUser -ne $NULL)) {  
            ...
            $SessionList = $SessionList + "`n`n" + $ServerName + " logged in by " + $RDPUser + " on " + $sessionType + " State " + $state
        } 
    } 
} 
